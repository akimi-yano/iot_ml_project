...
ap.add_argument("-e", "--embedding-model", required=True, help="path to the embedding model")
ap.add_argument("-l", "--label-encoder", required=True, help="path to the label encoder")
...
fr = FaceRecognizer(args["classifier"], args["embedding_model"], args["label_encoder"])
...
while True:
	...
	faceRects = fd.detect(frame, scaleFactor=1.1, minNeighbors=5, minSize=(100, 100))
